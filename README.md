...
О обеспечивает прохождение всех тестов,
1 не содержит дублирующегося кода,
2 выражает намерения программиста,
3 использует минимальное количество классов и методов.
