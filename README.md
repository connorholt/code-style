...
- Имена таблиц во множественном числе, но все модели, контроллеры, называются в единственном. Как надо: таблица users, модель User
- Названия полей в базе через подчеркивание.
